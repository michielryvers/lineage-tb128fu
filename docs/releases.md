...
The source publication has no downloadable ROM image. The September 20 development upgrade and focused checks passed, but the remaining gates below still apply before a public binary release.
